...
public class EstabelecimentoRankAdapter extends RecyclerView.Adapter<EstabelecimentoRankAdapter.MyViewHolder> {

    private ArrayList<Estabelecimento> estabelecimentos;
    private LayoutInflater layoutInflater;
    public final Context context;

    public EstabelecimentoRankAdapter(Context context, ArrayList<Estabelecimento> estabelecimentos) {
    ...
    public void onBindViewHolder(MyViewHolder myViewHolder, final int position) {
        ...
        if(estabelecimentos.get(position).getPosicaoRank() == 1){
            myViewHolder.imgMedalha.setImageResource(R.drawable.medalha_ouro);
        }else if(estabelecimentos.get(position).getPosicaoRank() == 2){
